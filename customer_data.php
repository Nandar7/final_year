...
if(isset($_GET['Action']))
{
    ...
    if ($run)
        {
            echo "<script>
                window.alert('Customer Account deleted');
                window.location='customer_data.php';
              </script>";
        }
    }
...
<h2 >Customer Information</h2>
            ...
            { 
              ...
              <td class='product-name'>$customer_id</td>
               <td class='product-name'>$customer_name</td>
                ...
                <td class='product-name'>$email</td>
                     ...
                     <td>
                                                ...
                                                |
                            <a href='customer_data.php?Action=D&customer_id=$customer_id' class='btn btn-danger'>Delete</a>
                        </td>
