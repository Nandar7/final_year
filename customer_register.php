						      ...
						      <div class="card-body">
						        <div class="billing-address-form">
						        	<form action="customer_register.php" method="POST">
						        		...
						        		<p><input type="hidden" name="customer_id" >
						        			<label>Name</label>
						        		<input type="text" name="customer_name" placeholder="Enter Your Name" required></p>
						        		<label>Phone</label>
						        		<p><input type="text" name="phone" placeholder="Enter Your Phone Number" required></p>
						        		<label>Address</label>
						        		<p><textarea name="address" id="bill" cols="30" rows="10" placeholder="Enter Your Address" required></textarea></p>
						        		<label>Email</label>
